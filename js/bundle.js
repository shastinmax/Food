...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "getCloseModal": () => (/* binding */ getCloseModal),
/* harmony export */   "getOpenModal": () => (/* binding */ getOpenModal)
/* harmony export */ });
...
function slider(){
  ...
  `;
    ...
    prev.addEventListener("click", () => {
        if (offset === 0) {
            offset = replaceExpression(width) * (slides.length - 1);
        } else {
            offset -= replaceExpression(width);
        }
        ...
        dots.forEach((dot) =>
            dot.addEventListener("click", (e) => {
                ...
                slideIndex = slideTo;
                offset = +replaceExpression(width) * (slideTo - 1);
                slidesField.style.transform = `translateX(-${offset}px)`;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector,tabsSelectorContent,tabsSelectorParent,activeClass) {
    let tabs = document.querySelectorAll(tabsSelector),
        tabsContent = document.querySelectorAll(tabsSelectorContent),
        tabsParent = document.querySelector(tabsSelectorParent);
